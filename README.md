...
1. [python 의 입력과 출력 그리고 변수에 대하여](https://choi-hyunho.com/python/python-1/)
2. [python 의 데이터 타입](https://choi-hyunho.com/python/python-2/)
3. [문자열에 대해서](https://choi-hyunho.com/python/python-3/)
